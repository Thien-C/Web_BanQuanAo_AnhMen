...
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'ANH_MENCloneDB')
BEGIN
    ALTER DATABASE ANHMENCloneDB SET SINGLE_USER WITH ROLLBACK IMMEDIATE; -- Ngắt kết nối để drop
    DROP DATABASE ANHMENCloneDB;
END
GO

CREATE DATABASE ANHMENCloneDB;
GO
